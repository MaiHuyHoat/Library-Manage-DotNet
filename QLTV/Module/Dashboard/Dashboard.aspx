                            ...
                            <table cellpadding="0" cellspacing="0" class="w-100" style="height: 150px">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="3" style="width: 42px">
                                        <asp:Label ID="Label19" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="White" Text="18"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 12px">&nbsp;</td>
                                    <td>
                                        <asp:Label ID="Label20" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="White" Text="Đầu sách"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 21px">&nbsp;</td>
                        ...
                        <asp:Panel ID="Panel4" runat="server" BackColor="#3399FF" Height="150px" Width="250px">
                            <table cellpadding="0" cellspacing="0" class="w-100" style="height: 150px">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 12px">&nbsp;</td>
                                    <td rowspan="3" style="width: 42px">
                                        <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="White" Text="18"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                        ...
                        <asp:Panel ID="Panel5" runat="server" BackColor="#FF5050" Height="150px" Width="250px">
                            <table cellpadding="0" cellspacing="0" class="w-100" style="height: 150px">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 12px">&nbsp;</td>
                                    <td rowspan="3" style="width: 42px">
                                        <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="White" Text="18"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                        ...
                        <asp:Panel ID="Panel6" runat="server" BackColor="#FF99CC" Height="150px" Width="250px">
                            <table cellpadding="0" cellspacing="0" class="w-100" style="height: 150px">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 12px">&nbsp;</td>
                                    <td rowspan="3" style="width: 42px">
                                        <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="White" Text="18"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
