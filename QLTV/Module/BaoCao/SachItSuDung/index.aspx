...
&nbsp;<table class="w-100">
        ...
        <tr>
            ...
            <td colspan="7" style="background-color: rgb(75, 83, 102); height: 28px;">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="White" Text="Thống kê tình hình sách ít sử dụng của thư viện (6 tháng gần đây)"></asp:Label>
            </td>
            <td colspan="7" style="background-color: rgb(75, 83, 102); height: 28px;">
